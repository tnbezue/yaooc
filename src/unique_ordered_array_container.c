...
yaooc_unique_ordered_array_container_class_table_t yaooc_unique_ordered_array_container_class_table =
{
  ...
  .begin = (iterator (*) (const_pointer p)) yaooc_unique_ordered_array_container_begin,
  .end = (iterator (*) (const_pointer p)) yaooc_unique_ordered_array_container_end,
};


DEFINE_TYPE_INFO(yaooc_unique_ordered_array_container,NULL,NULL,NULL,NULL,NULL,NULL,NULL,
			&yaooc_unique_ordered_array_container_class_table,yaooc_ordered_array_container)
