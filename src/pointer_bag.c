...
DEFINE_TYPE_INFO(yaooc_pointer_bag,yaooc_pointer_bag_default_ctor,yaooc_pointer_bag_dtor,NULL,NULL,NULL,NULL,NULL,
		&yaooc_pointer_bag_class_table,yaooc_pod_array)
