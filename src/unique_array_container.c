...
yaooc_unique_array_container_class_table_t yaooc_unique_array_container_class_table =
{
  ...
  .begin = (iterator (*) (pointer p)) yaooc_unique_array_container_begin,
  .end = (iterator (*) (pointer p)) yaooc_unique_array_container_end,
  .cbegin = (const_iterator (*) (const_pointer p)) yaooc_unique_array_container_begin,
  .cend = (const_iterator (*) (const_pointer p)) yaooc_unique_array_container_end,
};
