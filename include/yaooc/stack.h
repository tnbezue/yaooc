...
class(T ## _stack); \
ISA_DEFINITION(T ## _stack,yaooc_container)

#define STACK_IMPLEMENTATION(T) \
void T ## _stack_default_ctor(pointer p) { call_constructor(p,yaooc_container_ctor,T ## _ti); } \
void T ## _stack_push_v(pointer p,T ## _t v) { yaooc_stack_push(p,&v); } \
ISA_IMPLEMENTATION(T ## _stack,yaooc_container) \
...
{\
  ...
  (T ## _stack_iterator(*)(pointer)) yaooc_container_begin, \
  (T ## _stack_iterator(*)(pointer)) yaooc_container_end, \
  (T ## _stack_const_iterator(*)(const_pointer)) yaooc_container_begin, \
  (T ## _stack_const_iterator(*)(const_pointer)) yaooc_container_end, \
};\
DEFINE_TYPE_INFO(T ## _stack,T ## _stack_default_ctor,NULL,NULL,NULL,NULL, \
        &T ## _stack_class_members,yaooc_container)
