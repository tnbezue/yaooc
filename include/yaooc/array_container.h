...
/* Type Info Prototypes for yaooc_array_container */
...
/* Table prototypes for yaooc_array_container */
...
const_iterator yaooc_array_container_cbegin(const_pointer);
const_iterator yaooc_array_container_cend(const_pointer);

/* Protected prototypes for yaooc_array_container */
extern iterator yaooc_array_container_insert_space(pointer, const_iterator, size_t);
extern iterator yaooc_array_container_erase_space(pointer, const_iterator, size_t);
extern iterator yaooc_array_container_replace_space(pointer, const_iterator, const_iterator, size_t);
extern iterator yaooc_array_container_find(pointer, const_pointer);
extern iterator yaooc_array_container_insert(pointer, const_iterator, const_pointer);
extern iterator yaooc_array_container_insertn(pointer, const_iterator, size_t, const_pointer);
extern iterator yaooc_array_container_insert_range(pointer, const_iterator, const_iterator, const_iterator);
extern iterator yaooc_array_container_erase(pointer, const_iterator);
extern iterator yaooc_array_container_erase_range(pointer, const_iterator, const_iterator);
extern size_t yaooc_array_container_erase_value(pointer, const_pointer);
extern iterator yaooc_array_container_at(const_pointer,size_t);
extern void yaooc_array_container_shrink_to_fit(pointer);
extern void yaooc_array_container_reserve(pointer, size_t);
extern void yaooc_array_container_resize(pointer, size_t);
extern void yaooc_array_container_resize_value(pointer, size_t, const_pointer);
extern void yaooc_array_container_clear(pointer);
