...
class(T ## _set);\
ISA_DEFINITION(T ## _set,yaooc_unique_index_container)
...
ISA_IMPLEMENTATION(T ## _set,yaooc_unique_index_container) \
...
{\
  { \
	...
	(T ## _set_iterator (*) (pointer,iterator)) yaooc_unique_index_container_erase, \
	(T ## _set_iterator (*) (pointer,iterator,iterator)) yaooc_unique_index_container_erase_range, \
	(T ## _set_iterator (*)(pointer,const_iterator)) yaooc_index_container_find, \
	(T ## _set_const_iterator (*)(const_pointer,const_iterator)) yaooc_index_container_find, \
	(T ## _set_iterator (*) (pointer)) yaooc_container_begin, \
	(T ## _set_iterator (*)(pointer)) yaooc_container_end, \
	(T ## _set_const_iterator (*) (const_pointer)) yaooc_container_begin, \
	(T ## _set_const_iterator (*)(const_pointer)) yaooc_container_end \
};\
DEFINE_TYPE_INFO(T ## _set,T ## _set_default_ctor,NULL,NULL,NULL,NULL, \
        &T ## _set_class_members,yaooc_unique_index_container)
