...
class(K ## _ ## V ## _map);\
ISA_DEFINITION(K ## _ ## V ## _map,yaooc_unique_index_container)
...
ISA_IMPLEMENTATION(K ## _ ## V ## _map,yaooc_unique_index_container) \
...
{ \
  { \
	...
	(K ## _ ## V ## _map_iterator (*) (pointer,iterator)) yaooc_unique_index_container_erase, \
	(K ## _ ## V ## _map_iterator (*) (pointer,iterator,iterator)) yaooc_unique_index_container_erase_range, \
	...
	(K ## _ ## V ## _map_iterator (*) (pointer)) yaooc_container_begin, \
	(K ## _ ## V ## _map_iterator (*)(pointer)) yaooc_container_end, \
	(K ## _ ## V ## _map_const_iterator (*) (const_pointer)) yaooc_container_begin, \
	(K ## _ ## V ## _map_const_iterator (*)(const_pointer)) yaooc_container_end, \
};\
