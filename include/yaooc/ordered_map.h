...
// Member methods
yaooc_ordered_array_container_find_result_t yaooc_ordered_map_insert(pointer,const_pointer);
...
ISA_DEFINITION(K ## _ ## V ## _ordered_map,yaooc_unique_ordered_array_container)
...
{ \
  ...
  yaooc_ordered_array_container_find_result_t fr=yaooc_ordered_map_insert(p,pair); \
  if(fr.found_) \
...
ISA_IMPLEMENTATION(K ## _ ## V ## _ordered_map,yaooc_unique_ordered_array_container) \
...
{ \
  { \
	...
	(K ## _ ## V ## _ordered_map_iterator (*) (pointer,iterator)) yaooc_unique_ordered_array_container_erase, \
	(K ## _ ## V ## _ordered_map_iterator (*) (pointer,iterator,iterator)) yaooc_unique_ordered_array_container_erase_range, \
	...
	(K ## _ ## V ## _ordered_map_iterator (*) (pointer)) yaooc_array_container_begin, \
	(K ## _ ## V ## _ordered_map_iterator (*)(pointer)) yaooc_array_container_end, \
	(K ## _ ## V ## _ordered_map_const_iterator (*) (const_pointer)) yaooc_array_container_begin, \
	(K ## _ ## V ## _ordered_map_const_iterator (*)(const_pointer)) yaooc_array_container_end, \
};\
DEFINE_TYPE_INFO(K ## _ ## V ## _ordered_map,K ## _ ## V ## _ordered_map_default_ctor, \
        NULL,NULL,NULL,NULL,& K ## _ ## V ## _ordered_map_class_members,yaooc_unique_ordered_array_container)
