...
const char* int_array_container_isa(const_pointer p) { return "int_array_container_t"; }
int_array_container_class_table_t int_array_container_class_table=
{
  ...
  .isa = int_array_container_isa, /* isa */
...
const char* simple_object_array_container_isa(const_pointer p) { return "simple_object_array_container_t"; }
...
simple_object_array_container_class_table_t simple_object_array_container_class_table=
{
  ...
  .isa = simple_object_array_container_isa, /* isa */
  .is_descendant = (bool(*) (const_pointer,const char*)) yaooc_object_is_descendant, /* is_descendant  */
  .swap = yaooc_array_container_swap, /* swap  */
  .increase_capacity = (bool (*) (pointer,size_t)) yaooc_pod_array_increase_capacity,
  .size_needed = (size_t (*)(const_pointer,size_t)) yaooc_pod_array_size_needed,
