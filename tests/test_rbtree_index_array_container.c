...
typedef int_t* int_rbtree_index_array_container_iterator;
typedef const int_t* int_rbtree_index_array_container_const_iterator;

yaooc_class_table(int_rbtree_index_array_container)
{
  yaooc_rbtree_index_array_container_class_table_t;
	int_rbtree_index_array_container_iterator (*find)(const_pointer,const_pointer);
	int_rbtree_index_array_container_const_iterator (*insert)(const_pointer,const_iterator,const_pointer);
	int_rbtree_index_array_container_const_iterator (*insert_range)(const_pointer,const_iterator,const_iterator,const_iterator);
	int_rbtree_index_array_container_const_iterator (*insert_n)(const_pointer,const_iterator,size_t,const_pointer);
	int_rbtree_index_array_container_iterator (*erase)(pointer,const_iterator);
	int_rbtree_index_array_container_iterator (*erase_range)(pointer,const_iterator,const_iterator);
	...
	void (*clear)(pointer);
  int_rbtree_index_array_container_const_iterator(*at)(const_pointer,size_t);
};

yaooc_class_instance(int_rbtree_index_array_container)
{
  yaooc_rbtree_index_array_container_class_instance_t;
};

yaooc_class(int_rbtree_index_array_container);

void int_rbtree_index_array_container_default_ctor(pointer d)
{
	call_constructor(d,yaooc_rbtree_index_array_container_ctor_ti,int_ti);
}

size_t int_rbtree_index_array_container_erase_value(pointer p,int_t value)
{
	return yaooc_rbtree_index_array_container_erase_value(p,&value);
}
...
void print_indexes(int_rbtree_index_array_container_const_pointer this)
{
  optr=output;
  *optr=0;
	print_index(yaooc_rbtree_index_array_container_rbfirst(this));
	printf("M%sM\n",output);
}

void print_value(int_rbtree_index_array_container_const_pointer this)
{
  optr=output;
  *optr=0;
  size_t i;
...
void print_in_order(int_rbtree_index_array_container_const_pointer this)
{
...
bool index_ordered(int_rbtree_index_array_container_const_pointer this)
{
  rbtree_indexes = (unsigned int*)MALLOC(M(this,size)*sizeof(unsigned int));
	irb=0;
	bool rc=true;
...
{
  .parent_class_table_ = (const class_table_t*)&yaooc_rbtree_index_array_container_class_table, /* parent_class_table_ */
  .type_name_ = (const char*) "int_rbtree_index_array_container_t",
  .swap = yaooc_rbtree_index_array_container_swap, /* swap  */
  ...
  .cend = (const_iterator (*) (const_pointer)) yaooc_array_container_end, /*end  */
	.find = (int_rbtree_index_array_container_iterator (*)(const_pointer,const_pointer))yaooc_rbtree_index_array_container_find, /* find */
	.insert = (int_rbtree_index_array_container_const_iterator (*)(const_pointer,const_iterator,const_pointer))yaooc_rbtree_index_array_container_insert,  /* insert */
	.insert_range = (int_rbtree_index_array_container_const_iterator (*)(const_pointer,const_iterator,const_iterator,const_iterator))yaooc_rbtree_index_array_container_insert_range,  /* insert_range */
	.insert_n = (int_rbtree_index_array_container_const_iterator (*)(const_pointer,const_iterator,size_t,const_pointer))yaooc_rbtree_index_array_container_insertn, /* insert_n */
	.erase = (int_rbtree_index_array_container_iterator (*)(pointer,const_iterator))yaooc_rbtree_index_array_container_erase, /* erase */
	.erase_range = (int_rbtree_index_array_container_iterator (*)(pointer,const_iterator,const_iterator))yaooc_rbtree_index_array_container_erase_range, /* erase_range */
	.erase_value = (size_t (*)(pointer,int_t))int_rbtree_index_array_container_erase_value, /* erase_value */
	.resize = (void (*)(pointer,size_t))yaooc_rbtree_index_array_container_resize, /* resize */
	.resize_value = (void (*)(pointer,size_t,const_pointer))yaooc_rbtree_index_array_container_resize_value, /* resize */
	.shrink_to_fit = (void (*)(pointer))yaooc_rbtree_index_array_container_shrink_to_fit, /* shrink_to_fit */
	.clear = (void (*)(pointer))yaooc_rbtree_index_array_container_clear, /* clear */
  .at = (int_rbtree_index_array_container_const_iterator(*)(const_pointer,size_t)) yaooc_array_container_at
};

DEFINE_TYPE_INFO(int_rbtree_index_array_container,Y,N,N,N,N,N,N,Y,yaooc_rbtree_index_array_container);
...
void test_copy()
{
	...
	int n=ARRAY_SIZE(values);
  int_rbtree_index_array_container_pointer pos=M(c1,begin);
