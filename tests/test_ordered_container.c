...
class_table(int32_ordered_container)
{
  ...
  int32_ordered_container_const_iterator (*insert_n)(const_pointer,const_iterator,yaooc_size_type,const_pointer);
  ...
  yaooc_size_type (*erase_value)(pointer,int32_t);
...
yaooc_size_type int32_ordered_container_erase_value(pointer p,int32_t value)
{
	return yaooc_ordered_array_container_erase_value(p,&value);
}

int32_ordered_container_class_members_t int32_ordered_container_class_members=
{
  { YAOOC_ORDERED_ARRAY_CONTAINER_CLASS_MEMBERS },
	(int32_ordered_container_iterator (*)(const_pointer,const_pointer))yaooc_ordered_array_container_find,
	(int32_ordered_container_const_iterator (*)(const_pointer,const_pointer))yaooc_ordered_array_container_find,
	(int32_ordered_container_iterator (*)(pointer))yaooc_ordered_array_container_begin,
	(int32_ordered_container_iterator (*)(pointer))yaooc_ordered_array_container_end,
	(int32_ordered_container_const_iterator (*)(const_pointer))yaooc_ordered_array_container_begin,
	(int32_ordered_container_const_iterator (*)(const_pointer))yaooc_ordered_array_container_end,
	(int32_ordered_container_const_iterator (*)(const_pointer,const_iterator,const_pointer))yaooc_ordered_array_container_insert,
	(int32_ordered_container_const_iterator (*)(const_pointer,const_iterator,const_iterator,const_iterator))yaooc_ordered_array_container_insert_range,
	(int32_ordered_container_const_iterator (*)(const_pointer,const_iterator,yaooc_size_type,const_pointer))yaooc_ordered_array_container_insert_n,
	(int32_ordered_container_iterator (*)(pointer,const_iterator))yaooc_ordered_array_container_erase,
	(int32_ordered_container_iterator (*)(pointer,const_iterator,const_iterator))yaooc_ordered_array_container_erase_range,
	(yaooc_size_type (*)(pointer,int32_t))int32_ordered_container_erase_value,
	(void (*)(pointer,yaooc_size_type,const_pointer))yaooc_ordered_array_container_resize,
	(void (*)(pointer))yaooc_ordered_array_container_shrink_to_fit,
};

DEFINE_TYPE_INFO(int32_ordered_container,int32_ordered_container_default_ctor,
      NULL,NULL,NULL,NULL,&int32_ordered_container_class_members,yaooc_array_container)

void test_sizes()
{
	printf("%zu\n",sizeof(int32_ordered_container_t));
	TEST("SIZE container == 40",sizeof(int32_ordered_container_t)== 40);
}
...
class_table(simple_object_ordered_container)
{
  ...
  simple_object_ordered_container_const_iterator (*insert_n)(const_pointer,const_iterator,yaooc_size_type,const_pointer);
  ...
  yaooc_size_type (*erase_value)(pointer,simple_object_t);
  void (*resize)(pointer,yaooc_size_type,const_pointer);
  void (*shrink_to_fit)(pointer);
};
...
yaooc_size_type simple_object_ordered_container_erase_value(pointer p,simple_object_t so)
{
	return yaooc_ordered_array_container_erase_value(p,&so);
}

simple_object_ordered_container_class_members_t simple_object_ordered_container_class_members=
{
  { YAOOC_ORDERED_ARRAY_CONTAINER_CLASS_MEMBERS },
	(simple_object_ordered_container_iterator (*)(const_pointer,const_pointer))yaooc_ordered_array_container_find,
	(simple_object_ordered_container_const_iterator (*)(const_pointer,const_pointer))yaooc_ordered_array_container_find,
	(simple_object_ordered_container_iterator (*)(pointer))yaooc_ordered_array_container_begin,
	(simple_object_ordered_container_iterator (*)(pointer))yaooc_ordered_array_container_end,
	(simple_object_ordered_container_const_iterator (*)(const_pointer))yaooc_ordered_array_container_begin,
	(simple_object_ordered_container_const_iterator (*)(const_pointer))yaooc_ordered_array_container_end,
	(simple_object_ordered_container_const_iterator (*)(const_pointer,const_iterator,const_pointer))yaooc_ordered_array_container_insert,
	(simple_object_ordered_container_const_iterator (*)(const_pointer,const_iterator,const_iterator,const_iterator))yaooc_ordered_array_container_insert_range,
	(simple_object_ordered_container_const_iterator (*)(const_pointer,const_iterator,yaooc_size_type,const_pointer))yaooc_ordered_array_container_insert_n,
	(simple_object_ordered_container_iterator (*)(pointer,const_iterator))yaooc_ordered_array_container_erase,
	(simple_object_ordered_container_iterator (*)(pointer,const_iterator,const_iterator))yaooc_ordered_array_container_erase_range,
	(yaooc_size_type (*)(pointer,simple_object_t))simple_object_ordered_container_erase_value,
	(void (*)(pointer,yaooc_size_type,const_pointer))yaooc_ordered_array_container_resize,
	(void (*)(pointer))yaooc_ordered_array_container_shrink_to_fit
};
